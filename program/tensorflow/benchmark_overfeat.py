...
if (len(sys.argv[1:]) != 2):
    print("ERROR: benchmark takes 2 arguments: batch_size and num_batches")
    exit(1)

tf.app.flags.DEFINE_integer('batch_size', sys.argv[1],
                            """Batch size.""")
tf.app.flags.DEFINE_integer('num_batches', sys.argv[2],
