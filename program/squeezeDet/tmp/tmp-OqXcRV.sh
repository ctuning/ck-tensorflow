...
export CK_DATASET_PATH=/home/fanran/CK/ck-tensorflow/dataset/squeezedet-eval-train/

export CK_DATASET_FILENAME=squeezedet_eval_train.sh

echo    executing code ...
 sh /home/fanran/CK/ck-tensorflow/dataset/squeezedet-eval-train/squeezedet_eval_train.sh 
