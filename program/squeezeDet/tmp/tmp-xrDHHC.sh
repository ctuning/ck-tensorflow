...
export CK_DATASET_PATH=/home/fanran/CK/ck-tensorflow/dataset/squeezedet-eval-val/

export CK_DATASET_FILENAME=squeezedet_eval_val.sh

echo    executing code ...
 sh /home/fanran/CK/ck-tensorflow/dataset/squeezedet-eval-val/squeezedet_eval_val.sh 
