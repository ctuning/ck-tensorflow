...
${CK_ENV_COMPILER_PYTHON_FILE} "../image_benchmark.py" --input_file="$INPUT" --checkpoint="$CHECKPOINT" --demo_net="$NET" --batch_count=$CK_BATCH_COUNT --batch_size=$CK_BATCH_SIZE --gpu_mem_limit=$CK_TF_GPU_MEMORY_PERCENT
