...
$CK_PYTHON_BIN $PACKAGE_DIR/create_mscoco_record.py --label_map_path=$CK_ENV_TENSORFLOW_MODELS_ROOT/data/mscoco_label_map.pbtxt --data_dir=$CK_ENV_DATASET_COCO --output_dir=$DATA_DIR

cp -f $CK_ENV_TENSORFLOW_MODELS_ROOT/data/mscoco_label_map.pbtxt $DATA_DIR
