...
$CK_PYTHON_BIN $CK_ENV_TENSORFLOW_MODELS_ROOT/create_pascal_tf_record.py --label_map_path=$CK_ENV_TENSORFLOW_MODELS_ROOT/data/pascal_label_map.pbtxt --data_dir=$CK_ENV_DATASET_PASCAL_ROOT --year=VOC2012 --set=val --output_path=pascal_val.record
